...
with open('/Users/cesarmartincuadrado/downloads/datos.json', 'r') as archivo_json:
    datos = json.load(archivo_json)
    nivel_actual = datos['nivel']
    print(nivel_actual)
    os.remove('/Users/cesarmartincuadrado/downloads/datos.json')
...
with open('Hack4edu-SubjectMastery(Alumno)/nivel.json', 'r') as archivo:
...
modelo.fit(operando1, nivelOperacion, epochs=2000)
    ...
    if clasificacion == nivel_actual:
        while True:
            ...
            if clasificacion == nivel_actual:
                ...
                with open("Hack4edu-SubjectMastery(Alumno)/operandos_actuales.json", "w") as json_file:
